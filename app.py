...
try:
    ...
    # --- PERFIL HORARIO CONTINUO + CONTINUIDAD HISTÓRICA ---
    dt_series = pd.to_datetime(df_pred["fecha_hora"])
    df_pred["fecha_hora_dt"] = dt_series
    ...
    # Cálculo de potencia descontando caudal ecológico e interpolando curva SCADA
    potencias = []
    caudales_turbinados = []
